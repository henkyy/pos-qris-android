...
export default function SalesTerminal() {
  ...
  const paymentOptions: Array<Row & { id: string; code: PaymentCode }> = paymentMethods.map(method => ({ ...method, id: text(method.id), code: normalizePaymentCode(text(method.code || method.method_type)) })).filter((m, i, a) => !!m.id && a.findIndex(x => x.code === m.code) === i)
